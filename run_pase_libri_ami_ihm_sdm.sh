...
python -u train.py --batch_size 32 --epoch 50 \
        --save_path ckpt_PASE_QRNN_libri_ami_sdm1357_prechime5 \
        --num_workers 10 --warmup 10000000 --net_cfg cfg/workers.cfg \
        --fe_cfg cfg/PASE_dense_QRNN.cfg --do_eval \
        --min_lr 0.0005 --fe_lr 0.0005  \
        --stats data/libri_ami_ihm_stats.pkl --lrdec_step 30 --lrdecay 0.5 \
