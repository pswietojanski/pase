...
python -u train.py --batch_size 32 --epoch 50 --save_path ckpt_PASE_50h_newMI_noW_denseskips_alldistortions \
	...
	--distortion_p 0.5 --dtrans_cfg cfg/distortions/all.cfg \
